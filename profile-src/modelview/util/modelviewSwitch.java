...
public class modelviewSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case modelviewPackage.VIEW_OF: {
				ViewOf viewOf = (ViewOf)theEObject;
				T result = caseViewOf(viewOf);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case modelviewPackage.VIEW_CONTAINER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>View Of</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>View Of</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseViewOf(ViewOf object) {
		return null;
	}
