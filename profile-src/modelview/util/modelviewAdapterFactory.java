...
public class modelviewAdapterFactory extends AdapterFactoryImpl {
	...
	protected modelviewSwitch<Adapter> modelSwitch =
		new modelviewSwitch<Adapter>() {
			@Override
			public Adapter caseViewOf(ViewOf object) {
				return createViewOfAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link modelview.ViewOf <em>View Of</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createViewOfAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link modelview.ViewContainer <em>View Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
